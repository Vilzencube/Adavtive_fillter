...
for i = numel(e_NLMS):-1:2
    if(abs(e_NLMS(i))^2 > ConvergenceBound_NLMS)
         plot(i+1,abs(e_NLMS(i+1)).^2,'LineWidth',4);
...
figure
for i = 1:nMCT
    plot(AllFilterCoefficients_NLMS(i,:,2),AllFilterCoefficients_NLMS(i,:,1))
    hold on   
end
...
for i = numel(e_PNLMS):-1:2
    if(abs(e_PNLMS(i))^2 > ConvergenceBound_PNLMS)
         plot(i+1,abs(e_PNLMS(i+1)).^2,'LineWidth',4);
...
figure
for i = 1:nMCT
    plot(AllFilterCoefficients_PNLMS(i,:,2),AllFilterCoefficients_PNLMS(i,:,1))
    hold on    
end
...
for i = numel(e_IPNLMS):-1:2
    if(abs(e_IPNLMS(i))^2 > ConvergenceBound_IPNLMS)
         plot(i+1,abs(e_IPNLMS(i+1)).^2,'LineWidth',4);
...
figure
for i = 1:nMCT
    plot(AllFilterCoefficients_IPNLMS(i,:,2),AllFilterCoefficients_IPNLMS(i,:,1))
    hold on    
end
...
for i = numel(e_GCIPNLMS):-1:2
    if(abs(e_GCIPNLMS(i))^2 > ConvergenceBound_GCIPNLMS)
         plot(i+1,abs(e_GCIPNLMS(i+1)).^2,'LineWidth',4);
...
figure
for i = 1:nMCT
    plot(AllFilterCoefficients_GCIPNLMS(i,:,2),AllFilterCoefficients_GCIPNLMS(i,:,1))
    hold on    
end
...
nMCTforPlot = 1;
figure
plot(AllFilterCoefficients_NLMS(nMCTforPlot,:,2),AllFilterCoefficients_NLMS(nMCTforPlot,:,1))
hold on
plot(AllFilterCoefficients_PNLMS(nMCTforPlot,:,2),AllFilterCoefficients_PNLMS(nMCTforPlot,:,1))
plot(AllFilterCoefficients_IPNLMS(nMCTforPlot,:,2),AllFilterCoefficients_IPNLMS(nMCTforPlot,:,1))
plot(AllFilterCoefficients_GCIPNLMS(nMCTforPlot,:,2),AllFilterCoefficients_GCIPNLMS(nMCTforPlot,:,1))
